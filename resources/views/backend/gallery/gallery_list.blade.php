                            ...
                            <div class="card">
                                <div class="card-header border-transparent">
                                    ...
                                    <div class="card-tools">
                                        <a href="{{ route('admin.gallery.create') }}" class="btn btn-sm btn-info float-left" id="createGallery">Add New
                                            Gallery</a>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table id="contact_table" class="table m-0 gallery-table table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
...
// alert(url)
    $.ajax({
        ...
        success: function (response) {
            ...
            $('.gallery-table').DataTable().draw(false);
        },
...
$(document).on('click', '#editBtn', function () {
    ...
    $.ajax({
        type: 'post',
        url: "{{ route('admin.gallery.update',"+galleryId+") }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function (response) {
