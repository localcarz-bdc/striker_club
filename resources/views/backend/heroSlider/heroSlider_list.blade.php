                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header border-transparent">
                                    <h3 class="card-title">Hero Slider List</h3>
                                    <div class="card-tools">
                                        <a href="{{ route('admin.hero_slider.create') }}" class="btn btn-sm btn-info float-left" id="createHeroSlider">Add New
                                            Hero Slider</a>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table id="contact_table" class="table m-0 hero-slider-table table-bordered" style="width:100%">
                                            <thead>
                                                <tr>
            ...
            <div class="modal-dialog">
              <div class="modal-content bg-secondary">
                <div class="modal-header">
                  <h4 class="modal-title">Create Hero Slider</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <form  id="createHeroSliderForm" method="post" enctype="multipart/form-data">
                    @csrf
...
$(document).ready(function() {
    ...
    $(function() {
        var table = $('.hero-slider-table').DataTable({
            dom: "lBfrtip",
            buttons: [{
                extend: 'pdf',
            ...
            searchable: true,
            "ajax": {
                "url": "{{ route('admin.hero_slider.index') }}",
                "data": function(data) {
                    //filter options
...
$(document).on('click', '#createHeroSlider', function (e) {
    e.preventDefault();
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('.hero-slider-table').DataTable().draw(false);
        },
...
$(document).on('click', '#submitBtn', function () {
    ...
    var formData = new FormData($('#createHeroSliderForm')[0]);
    ...
    $.ajax({
        ...
        url: "{{ route('admin.hero_slider.store') }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function (response) {
...
$(document).on('click', '#editBtn', function () {
    ...
    $.ajax({
        type: 'post',
        url: "{{ route('admin.hero_slider.update',"+galleryId+") }}",
        data: formData,
        contentType: false,
        processData: false,
        success: function (response) {
