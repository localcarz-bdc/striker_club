        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Strikers Club, Inc. Debutante Membership</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <div class="modal-dialog">
              <div class="modal-content bg-secondary">
                ...
                <div class="modal-footer justify-content-between">
                  ...
                  <button type="button" class="btn btn-outline-light" data-dismiss="modal">Ok I read</button>
                </div>
              </div>
              <!-- /.modal-content -->
            </div>
...
$(document).ready(function() {
    $(function() {
        var table = $('.contact-table').DataTable({
            ...
            searchable: true,
            "ajax": {
                "url": "{{ route('admin.debutante.index') }}",
                "data": function(data) {
                    //filter options
...
$(document).on('change', '.is_approve', function (e) {
    ...
    const url = `{{ route('admin.debutante.is_approve', ':isApproveValue') }}`;
