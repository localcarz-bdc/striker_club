                        ...
                        <div class="card">
                            <div class="card-header border-transparent">
                                ...
                                <div class="card-tools">
                                    {{-- <a href="{{ route('member.profile.create') }}" class="btn btn-sm btn-info float-left" id="createMember">Reset Password</a> --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content bg-secondary">
                <div class="modal-header">
                    <h4 class="modal-title">Reset Password 03</h4>
...
@push('js')
    <script>
        ...
        $(document).on('click', '#submitBtn', function() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('member.profile.reset.store') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: function(response) {
        ...
        $(document).on('click', '#editBtn', function() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('member.profile.update', '+memberId+') }}",
                data: formData,
                contentType: false,
                processData: false,
                success: function(response) {
