                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table m-0  invoice_table">
                            ...
                            @empty
                                <tr>
                                    <td class="text-center" colspan="9"><a href="{{route('member.profile.index')}}">Back to Payment</a></td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="justify-content-between">
                        <div class="card-header">
                            <button type="button" class="btn btn-lg btn-info float-right" id="create_invoice">
                                <img class="pe-2" width="95%" src="{{ asset('/frontend/assets/img/paypal.png') }}" alt="paypal button image">
                            </button>
                        </div>
                    </div>
                </form>
