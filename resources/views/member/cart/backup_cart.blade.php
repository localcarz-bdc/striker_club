...
@section('content')
                    ...
                    <table class="table table-responsive">
                        ...
                        <tbody>
                            ...
                            @foreach ($invoices as $item)
                                ...
                                @php
                                    // $image_obj = $item->lead->inventory->local_img_url;
                                    // $image_splice = explode(',', $image_obj);
                                    // $image = str_replace(['[', "'"], '', $image_splice[0]);

                                    // $price = $item->lead->inventory->price_formate ?? 0;
                                    $price = $item->price ?? 0;

                                    // Extract numeric value from price
                                    $numeric_price = preg_replace('/[^0-9]/', '', $price);
                                    $price = is_numeric($numeric_price) ? intval($numeric_price) : 0; // Ensure $price is numeric
                                ...
                                <tr class="alert" role="alert">
                                    ...
                                    <td>
                                        {{-- <img src="{{ asset('frontend/') }}/{{ $image }}" alt="img"
                                            ...
                                            <i class="fas fa-dollar-sign circle-icon"></i>
                                    </td>
                                    <td>
                                        <div class="email">
                                    ...
                                    <td class="quantity">
                                        <div class="input-group">
                                            <input type="counter" name="quantity"
                                                class="quantity form-control input-number" value="1" min="1"
                                                max="100">
                                        </div>
                                    </td>

                                    <td><input class="amount-cart" type="text" style="border:none"
                                            value="{{ $price }}"></td>

                                    <td>
                                        <button class="deleteCart" type="button" data-id={{ $item->lead_id }}>
    ...
    <section style=" width: 23%; float:rigth" class="radio-section">
        <div class="radio-list">
            <h3 style="margin-top:18px; margin-bottom:15px;">Card Totals</h3>
            <hr>
            ...
            <div class="d-flex justify-content-between">
                ...
                <input style="border:none; background:none; font-weight:700; text-align:end" type="text"
                    id="subtotal" value="{{ $total }}">
            </div>
    ...
    <div class="radio-list">
        ...
        <div class="radio-item"><input name="radio" id="radio3"
                ...
                <button class="btn btn-info w-100">Proceed to checkout</button>
