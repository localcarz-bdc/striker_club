            ...
            <div class="row">
                <div class="col-xl-7 col-lg-7 col-md-12">
                    <div style="margin-top:105px">
                        ...
                        <!-- Buttons -->
                        <div class="mt-4">
                            <a href="{{ route('member.profile.index') }}" class="btn btn-primary me-3" style="background-color:#087880; border:none;">Back to profile</a>
                            <a href="{{ route('member.dashboard') }}" style="text-decoration: underline; color:rgb(8, 120, 128);">Go back to dashboard</a>
                        </div>
                    </div>
                </div>
