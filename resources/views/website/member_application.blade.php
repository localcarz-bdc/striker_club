                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control w-100" name="other_affiliations" id="other_affiliations" cols="30" rows="6"
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control w-100" name="why_desire" id="why_desire" cols="30" rows="6"
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','#submitBtn',function(e){
            ...
            // if(fname !== '' || lname !== '' || dob !== '' || age !== '' || address !== ''|| city !== '' || state !== '' || zip !== '' || telephone !== ''|| father !== '' || mother !== '' || hschool_graduation !== '' || college_university !== ''|| why_debutant !== '' || cgpa !== '' || why_debutant !== '' || is_debutant !== '' ||is_philosophy !== '' || is_learn_debutant !== '' || striker_category !== '' || name_of_striker !== ''|| signature_date !== '' || email !== '' || email === confirm_email ){
                ...
                $.ajax({
                    type: 'post',
                    url : "{{ route('member.application.store') }}",
                    data : formData,
